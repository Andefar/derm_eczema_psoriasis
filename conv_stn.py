...
save_dir = 'models_conv/'
vis_dir = 'plots_conv/'

H, W, C = 224, 224, 3
H_trans, W_trans, C_trans = 224, 224, 3
img_shape = (H, W, C)
...
def build_model(x_pl, input_width, input_height, output_dim):
    ...
    # spatial transformer
    l_trans1 = transformer(x_pl, loc_out, out_size=(H_trans, W_trans))
    l_trans1.set_shape([None, H_trans, W_trans, C_trans])
